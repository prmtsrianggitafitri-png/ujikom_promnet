<?php
  session_start();
    ...
    $jumlahData = count(query("SELECT * FROM data_buku"));
    ...
    $query_utama = "SELECT 
                          db.*, 
                          k.nama_kategori , k.tanggal_input
                      FROM 
                          data_buku db
                      INNER JOIN 
                          data_kategori k ON db.id_kategori = k.id_kategori
                      LIMIT $awalData, $jumlahDataPerHalaman";

                      $data_buku = query($query_utama);

  if(isset($_POST['tombol_search'])){
      $data_buku = search_data($_POST['keyword']);
  }
            ...
            >
              ...
              <a href="#" class="nav-link active">
                ...
                <ul class="nav nav-treeview">
                  <li class="nav-item">
                    <!-- kalau mau ngebuat navlink ada higlightnya bisa pake class="nav-link active" -->
            ...
            <div class="row">
              ...
              <!-- =============== ISI TABEL ADA DI SINI =============== -->
                ...
                <tr>
                    ...
                    <td>
                        <a href="ubah_data_buku.php?id_buku=<?= $data['id_buku'] ?>">
                            <button class="btn-sm btn-success">Edit</button>
                        </a>
                        

                        <a href="hapus_data_buku.php?id_buku=<?= $data['id_buku'] ?>">
