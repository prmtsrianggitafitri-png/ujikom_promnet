              ...
              <!-- =============== ISI FORM NYA DI SINI =============== -->
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_penulis" placeholder="Nama Penulis" autocomplete="off">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Judul Buku</label>
                        <input type="text" class="form-control" name="judul_buku" placeholder="Judul Buku" autocomplete="off">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Jumlah Halaman</label>
                        <input type="number" class="form-control" name="jumlah_halaman" placeholder="Jumlah Halaman" autocomplete="off">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" name="gambar" placeholder="Gambar" autocomplete="off">
                    </div>
                    <div class="mb-3">
