...
if( !isset($_SESSION["login"]) ) {
    ...
    if(isset($_POST['tombol_submit_kategori'])){
      //kalau tombol sumbit diklik langsung panggil ke tambah data
        $status = tambah_data_kategori($_POST);
        if($status === "Kategori sudah Ada!"){
            echo "
                <script>
                    alert('Kategori suda ada');
            ...
            echo "
                <script>
                    alert('Kategori ditambahkan ke database!');
                    document.location.href = 'index2.php';
                </script>
            ";
        }
              ...
              <!-- =============== ISI FORM NYA DI SINI =============== -->
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nama_kategori" placeholder="Masukan Kategori Baru" autocomplete="off">
                    </div>
                    <div class="mb-3">
                        <button class="btn-sm btn btn-primary" name="tombol_submit_kategori">Submit</button>
                    </div>
                </form>
              </div>
              <!--end::Col-->
