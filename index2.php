...
if( !isset($_SESSION["login"]) ) {
  ...
  if(isset($_POST['tombol_search'])){
      $data_kategori = search_data_kategori($_POST['keyword']);
  }
            ...
            <div class="row">
              ...
              <!-- =============== ISI TABEL ADA DI SINI =============== -->
                ...
                <tr>
                    ...
                    <td>
                        <a href="ubah_data_kategori.php?id_kategori=<?= $data['id_kategori'] ?>">
                            <button class="btn-sm btn-success">Edit</button>
                        </a>


                        <a href="hapus_data_kategori.php?id_kategori=<?= $data['id_kategori'] ?>">
