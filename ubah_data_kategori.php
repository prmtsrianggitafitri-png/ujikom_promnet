...
if( !isset($_SESSION["login"]) ) {
    ...
    $query = query("SELECT * FROM data_kategori WHERE id_kategori = $id_kategori")[0];
    // echo "<pre>";
    // var_dump($query);
    // echo "</pre>";
    $data_buku = $query;
    ...
    if(isset($_POST['tombol_submit'])){
        ...
        if(ubah_data_kategori($_POST) > 0){
            echo "
                <script>
                    alert('Kategori berhasil diubah di database!');
            ...
            echo "
                <script>
                    alert('Kategori gagal diubah di database!');
                    document.location.href = 'index2.php';
                </script>
            ";
        }
            ...
            <div class="row">
              ...
              <!-- =============== ISI FORM NYA DI SINI =============== -->
                <form action="" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="id_kategori" value="<?= $query['id_kategori'] ?>">
                    <div class="mb-3">
                        <label class="form-label">Nama Kategori</label>
                        <input type="text" class="form-control" name="nama_kategori" value="<?= $data_buku['nama_kategori'] ?>" autocomplete="off">
                    </div>
                    <div class="mb-3">
